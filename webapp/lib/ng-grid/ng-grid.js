    ...
    return function($scope, elm) {
        ...
        elm.bind('scroll', function(evt) {
            ...
            if ($scope.forceSyncScrolling) {
                ...
                scrollTimer = setTimeout(ensureDigest, 20);
            }
...
window.ngGrid.i18n['fr'] = {
    ...
    ngMenuText: 'Choix des colonnes:',
    ngShowingItemsLabel: 'Articles Affichage des:',
    ngTotalItemsLabel: 'Nombre total d\'éléments:',
    ngSelectedItemsLabel: 'Éléments sélectionnés:',
