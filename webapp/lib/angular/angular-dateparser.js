...
{'use strict';
    app.register.factory('dateParserHelpers', [
    function()
    {
        return {
    ...
    app.register.factory('$dateParser', ['$locale', 'dateParserHelpers',
    function($locale, dateParserHelpers)
    {
        ...
        return function(val, format)
        {
            ...
            // Initial values
            var i_val = 0, i_format = 0, format_token = '', year = 1970, month = 1, date = 1, hh = 0, mm = 0, ss = 0, ampm = 'am', now = new Date(), z = now.getTimezoneOffset() * -1;
