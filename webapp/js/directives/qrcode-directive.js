define(['app', 'qrcodeService'], function(app)
{'use strict';
	
	// Directive name must be in lower case
	app.register.directive('qr', ['$timeout', '$window', 'qrcodeService',
	function($timeout, $window, QRCode)
	{ 
		return {
			restrict : 'E',
